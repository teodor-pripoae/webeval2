...
urlpatterns = patterns('',
    ...
    url(r'^blog/(?P<username>[\w_.-@]+)/(?P<permalink>[\w-]+)/edit/$', 'app.controllers.blog_controller.edit_entry', name="edit_blog_entry"),
    url(r'^blog/(?P<username>[\w_.-@]+)/(?P<permalink>[\w-]+)/delete/$', 'app.controllers.blog_controller.delete_entry', name="delete_blog_entry"),
