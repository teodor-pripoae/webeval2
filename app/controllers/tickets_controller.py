...
def edit_ticket (request, ticket_id):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            print changed
            form.save()
            return redirect(reverse('display_ticket', kwargs={'ticket_id' : ticket.id }))
    else:
        if user.is_superuser:
...
def delete_comment (request, ticket_id, comment_id=None):
    ...
    if request.user.is_staff:
        ...
        return redirect(reverse("display_ticket", kwargs={'ticket_id' : ticket.id}) + "#comments")
