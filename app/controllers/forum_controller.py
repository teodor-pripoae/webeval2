...
@render_to("forum/display_board.html")
...
@render_to("forum/display_topic.html")
...
@login_required
@render_to("forum/new_topic.html")
...
@login_required
@render_to("grader/edit_post.html")
def edit_post (request, post_id):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            form.save()
            return redirect(reverse("display_topic", kwargs={'topic_id': post.topic.id }) + "#%d" % post.id)
    else:
